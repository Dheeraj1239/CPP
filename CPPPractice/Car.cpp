...
// template <typename T>
// Car<T>::Car(std::string vehicleId, int vehicleRegisteration, VehicleType vehicleType, Insurance *vehicleInsurancePlan, CarType _carType, T _carPrice, std::string _carColor)
// :Vehicle(vehicleId,vehicleRegisteration,vehicleType,vehicleInsurancePlan), _carType(_carType) , _carPrice(_carPrice), _carColor(_carColor)
// {
// }
